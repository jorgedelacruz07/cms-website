...
<div class="uk-container uk-container-center">
  <div class="uk-width-small-1-2 uk-container-center">
    <h3 class="uk-h2">CREAR PÁGINA DE PÁGINA WEB</h3>
    {!! Form::open(['action' => ['PagesController@store', $website->id], 'method' => 'post', 'id' => 'form-contacto', 'class' => 'uk-form uk-position-relative']) !!}
      {!! Form::token(); !!}
